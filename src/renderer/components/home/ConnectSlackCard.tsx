...
const COPY: Record<ConnectPrompt, { title: string; body: string; action: string }> = {
  'first-run': {
    ...
    body: 'You’ll sign in to Slack in a window, just like in your browser. Slack Archive then keeps your channels, direct messages and files, even after Slack hides them.',
