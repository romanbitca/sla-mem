      ...
      <>
        ...
        {justConnected && (
          <Callout tone="success" icon={<CheckIcon size={15} />} role="status">
            ...
            <p className="text-ink-muted">Slamem is fetching your history in the background.</p>
          </Callout>
        )}
        ...
        {hasAccount ? (
          ...
          <div className="flex flex-col gap-3">
            <p className="text-[13.5px] leading-relaxed text-ink-muted">
              You’ll sign in to Slack in a window, just like in your browser. Slamem then keeps a copy of your own
