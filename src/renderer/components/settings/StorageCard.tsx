...
import { useDeleteOldAttachments, useShowDataFolder, useStorage } from '../../lib/queries';
import { CLEANUP_MONTHS, monthsLabel } from '../connect/connection';
import { Fact } from '../home/parts';
import { AlertIcon, CheckIcon, DatabaseIcon, FolderIcon, TrashIcon } from '../icons';
...
/**
 * Disk use split into messages and attachments, the archive folder, and freeing space by removing
 * old downloads (messages are never deleted). Backups have their own card (BackupCard).
 */
