...
- **Back and Forward (0.3.8, §8.2):** asked for "like Slack", keeping 10–20 steps. Two arrows at
  ...
  the app keeps the window's last 21 places (their router keys) to know where the reader is and
  when to grey an arrow. Behind a dialog the shortcuts and mouse buttons do nothing.
